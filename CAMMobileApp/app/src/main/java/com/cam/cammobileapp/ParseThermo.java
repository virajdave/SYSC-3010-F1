...
public class ParseThermo extends AppCompatActivity {
    ...
    public ArrayList<Integer> parseString(String message) {
        ...
        ArrayList<Integer> id_thermo = new ArrayList<>();
        ...
        if (message.substring(0, 2).equals("00")) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (placeHolder == '2') {
                    ...
                    //System.out.println(addedId);
                    id_thermo.add(Character.getNumericValue(addedId));
